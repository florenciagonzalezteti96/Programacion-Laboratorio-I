...
int get_Int();
int get_Option_Int();
int calculate_results(int first_number, int second_number);
...
int calculate_results(int first_number, int second_number)
{
    ...
    {
    case 1:
        int addition=add_numbers(first_number, second_number);
        break;
    case 2:
        int subtraction=subtract_numbers(first_number, second_number);
        break;
    case 3:
        int division=divide_numbers(first_number, second_number);
        break;
    case 4:
        int multiplication=multiply_numbers(first_number, second_number);
        break;
    case 5:
        int factorial_first_number=get_factorial(first_number);
        int factorial_second_number=get_factorial(second_number);
        break;
    }
    return 0;
}
...
int show_option_menu()
{
    ...
    do
    {
        ...
        case 1:
            ...
            flag=1; //ingreso y valido el ingreso de primer operando
            break;
        case 2:
            second_number=get_Int();
            flag_two=1; //ingreso y valido el ingreso de segundo operando
            break;
        case 3:
            //muestro la calculadora (si el usuario ingreso primer y segundo operando)
            if(flag=0)
            {
